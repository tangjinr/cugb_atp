...
public class WM1Activity extends Activity implements OnClickListener {
	...
	private void webViewInit() {
		mWV.loadUrl("http://waimai.baidu.com/");
	...
	private void goBack() {
		Intent intent = new Intent(WM1Activity.this, WMActivity.class);
